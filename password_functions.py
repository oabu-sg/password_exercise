...
def strength_checker():
    ...
    if is_Common(user_pw) or users_name_check(personal_details_dict['First Name'], personal_details_dict['Last Name'],
        ...
        print("Password cannot contain your personal details.")
        strength_count = 0
